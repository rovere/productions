...
def main():
    ...
    measurements_50bx.append(Measure('AVE_25_BX_50ns/DQM_V0001_R000000001__MyTiming__Release53X__PU25_BX50.root', 1))
    measurements_50bx.append(Measure('AVE_50_BX_50ns/DQM_V0001_R000000001__MyTiming__Release53X__PU50_BX50.root', 1))
    measurements_25bx.append(Measure('AVE_25_BX_25ns/DQM_V0001_R000000001__MyTiming__Release53X__PU25_BX25.root' ,1))
    measurements_25bx.append(Measure('AVE_40_BX_25ns/DQM_V0001_R000000001__MyTiming__Release53X__PU40_BX25.root' ,1))
    measurements_25bx.append(Measure('AVE_70_BX_25ns/DQM_V0001_R000000001__MyTiming__Release53X__PU70_BX25.root' ,1))
    #measurements_25bx.append(Measure('AVE_140_BX_25ns/DQM_V0001_R000000001__MyTiming__Release53X__PU140_BX25.root' ,1))
...
#    FillStyle = 3ijk, i(1,9)=space[0.5, 6]mm, j(0,9)=angle[0,90], k(0,9)=angle[90,180]
    ...
    # 50 ns
    totalEventTime_vs_PU(measurements_50bx, "53X", fillStyle, NoFill)
    totalEventTime_vs_LUMI(measurements_50bx, "53X", fillStyle, NoFill)
    iterativeTime(measurements_50bx, "53X", fillStyle, NoFill)

    # 25 ns
    totalEventTime_vs_PU(measurements_25bx, "53X", fillStyle, NoFill)
    totalEventTime_vs_LUMI(measurements_25bx, "53X", fillStyle, NoFill)
    iterativeTime(measurements_25bx, "53X", fillStyle, NoFill)
