...
# with command line options: DIGI_PU140_BX25 --datatier GEN-SIM-RAW --conditions auto:startup -s DIGI,L1,DIGI2RAW,HLT:@relval --eventcontent FEVTDEBUG -n 500 --filein /eos/something --pileup AVE_140_BX_25ns --pileup_input /eos/somthingelse --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('DIGI_PU140_BX25 nevts:500'),
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('DIGI_PU140_BX25_DIGI_L1_DIGI2RAW_HLT_PU.root'),
