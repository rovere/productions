...
process.dqmSaver.workflow = cms.untracked.string('/MyTiming/Release720pre4-NoDynInef/%s' % JOB_LABEL)
...
process.jetCoreRegionalStepSeeds.ClusterCheckPSet.doClusterCheck = cms.bool(False)
...
process.jetCoreRegionalStepSeeds.OrderedHitsFactoryPSet.maxElement = cms.uint32(10000000)
...
process.jetCoreRegionalStepTrackCandidates.maxNSeeds = 100000000
