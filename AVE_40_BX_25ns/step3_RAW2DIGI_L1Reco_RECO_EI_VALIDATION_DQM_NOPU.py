...
# with command line options: step3 --conditions auto:run2_mc --filein file:./step2_DIGI_L1_DIGI2RAW_HLT_RAW2DIGI_L1Reco.root -n 9000 --eventcontent RECOSIM,DQM -s RAW2DIGI,L1Reco,RECO,EI,VALIDATION,DQM --datatier GEN-SIM-RECO,DQMIO --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --magField 38T_PostLS1 --python_filename=step3_RAW2DIGI_L1Reco_RECO_EI_VALIDATION_DQM_NOPU.py --no_exec
