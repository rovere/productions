...
readFiles.extend( ['/store/group/phys_tracking/samples_720pre4/RECO/AVE_%s/TTbar/step3_%sNODUP_RAW2DIGI_L1Reco_RECO_DQM.root' %(JOB_LABEL,JOB_LABEL)] );
...
process.dqmSaver.workflow = cms.untracked.string('/Validation/Release720pre4/%s' % JOB_LABEL)
